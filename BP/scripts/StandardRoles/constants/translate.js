export const WEREWOLF_STANDARDROLES_TRANSLATE_IDS = {
    ...
    WEREWOLF_GAME_RESULT_WEREWOLF_FACTION_VICTORY_TITLE: "werewolf-standardroles.game.result.werewolffaction.victory.title",
    ...
    SEER_SKILL_NO_AVAILABLE_TARGETS_ERROR: "werewolf-standardroles.skill.seer.noAvailableTargets.error",
    ...
    MEDIUM_SKILL_FORM_TARGET_DROPDOWN_LABEL: "werewolf-standardroles.skill.medium.form.target.dropdown.label",
    MEDIUM_SKILL_CLAIRVOYANCE_RESULT: "werewolf-standardroles.skill.medium.clairvoyance.result",
    MEDIUM_SKILL_NO_AVAILABLE_TARGETS_ERROR: "werewolf-standardroles.skill.medium.noAvailableTargets.error",
};
